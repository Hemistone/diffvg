...
def _path_to_gaussians(
    ...
    # Use stroke alpha directly for now (spacing-aware normalization disabled for correctness)
    # This matches baseline compositing semantics and avoids overly faint output.
