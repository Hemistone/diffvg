...
def main() -> None:
    ...
    run = create_run_context("single_curve_outline", num_iterations, video_fps=24)
    log_run_configuration(
        "single_curve_outline",
        {
    ...
    points_n = torch.tensor(
        [
            ...
            [100.0 / 256.0, 200.0 / 256.0],
            [170.0 / 256.0, 55.0 / 256.0],
            [220.0 / 256.0, 100.0 / 256.0],
            [210.0 / 256.0, 80.0 / 256.0],
            [140.0 / 256.0, 60.0 / 256.0],
        ],
        requires_grad=True,
    )
    ...
    optimizer = torch.optim.Adam(
        [points_n, fill_color, stroke_color, stroke_width_n], lr=learning_rate
    )
