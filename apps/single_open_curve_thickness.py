...
def main() -> None:
    ...
    run = create_run_context("single_open_curve_thickness", num_iterations, video_fps=24)
    log_run_configuration(
        "single_open_curve_thickness",
        {
    ...
    thickness_n = torch.tensor([0.1, 0.1, 0.1, 0.1], requires_grad=True)
    ...
    optimizer = torch.optim.Adam([points_n, thickness_n, stroke_color], lr=learning_rate)
